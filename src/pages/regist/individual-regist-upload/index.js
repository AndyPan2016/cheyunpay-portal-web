...
export default {
  data () {
    return {
      uploadLists: [
        ...
        { text: '门头照（需法人手持身份证与门头合影)', key: 'doorPhotoPath', background: require('../../../assets/images/background/bg-facade.png') },
        { text: '法人手持银行卡照片', key: 'holdCertPath', background: require('../../../assets/images/background/bg-individual-bank.png') }
      ],
      uploadButtons: [
  ...
  methods: {
    ...
    registSubmit () {
      ...
      let key
      let falseItem
      let params = this.transfToJson(this.getLocalStorage(STATUS.INDIVIDUALREGIST)) || {}
      ...
      if (falseItem) {
        ...
        RegistService.individualRegister(params).then(res => {
          let data = res.data
          if (data.success) {
            // 去公共流程状态页
